...
!function () {
    ...
    t.protocol + "//" + t.host + t.pathname === l ? x(e.body, function (e) { for (var t = {}, o = e.split("&"), n = 0, a = o.length; n < a; n++) {
        ...
        f(e, /m/, t); }(function () { for (var t = e.querySelectorAll ? e.querySelectorAll("a.github-button") : function () { for (var t = [], o = e.getElementsByTagName("a"), r = 0, n = o.length; r < n; r++)
        ~(" " + o[r].className + " ").replace(/[ \t\n\f\r]+/g, " ").indexOf(" github-button ") && t.push(o[r]); return t; }(), o = 0, r = t.length; o < r; o++)
        !function (e) { k(e, function (t) { e.parentNode.replaceChild(t, e); }); }(t[o]); });
}();
